        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="group">
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="flex items-center space-x-2 text-xs text-slate-400 hover:text-emerald-300 transition-colors duration-300 cursor-default group/badge">
                <svg className="w-3 h-3 text-emerald-400 group-hover/badge:scale-125 group-hover/badge:rotate-6 transition-transform duration-300" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                  <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/>
                  <path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/>
                </svg>
                <span className="group-hover/badge:font-medium transition-all duration-300">Zero Carbon Footprint</span>
              </div>
            </div>
          </div>
        </div>
